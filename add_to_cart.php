...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($checkStmt->rowCount() > 0) {
            ...
            $stmt->execute([':username' => $username, ':product_id' => $product_id, ':variation_id' => $variation_id, ': Generated by BLACKBOX.AI, try unlimited chat https://www.blackbox.ai

variation_value' => $variation_value, ':quantity' => $quantity, ':price_per_variation' => $price_per_variation]);
