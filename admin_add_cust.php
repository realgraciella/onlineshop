...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO users (first_name, last_name, sex, bday, address, num, email, password, conpass, image) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);

    try {
        $stmt->execute([$fname, $lname, $sex, $bday, $address, $mnum, $email, $pass, $conpass, $imagePath]);
        echo 'success';
    } catch (Exception $e) {
