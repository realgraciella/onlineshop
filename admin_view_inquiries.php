...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $selectedCell = $_POST['inquiry_id']; // Assuming inquiry_id is the identifier
        ...
        try {
            $updateSql = "UPDATE inquiries SET reply = :reply WHERE inquiry_id = :cell";
...
<body>
  ...
  <main id="main">
    ...
    <section>
        <h2 style="text-align: center; margin-top: 50px; margin-bottom: 50px;">INQUIRIES</h2>
    ...
    <script>
        ...
        function addReply() {
            ...
            data.append('inquiry_id', selectedInquiryId);

            // Make the fetch request
            fetch('admin_view_inquiries.php', {
                method: 'POST',
                body: data,
                headers: {
